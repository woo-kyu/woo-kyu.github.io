...
- Manhattan distance 또는 Taxicab geometry 라고도 불린다.
  <img width="1000" alt="untitle" src="https://github.com/user-attachments/assets/6722308d-abaf-4a87-920f-6860e626a8b4">{: .align-center}
...
- $\sum^{n}_{i=1}\textrm{abs(}w_{i}\textrm{)}$: L1 Norm. 가중치 절대값의 합
