...
EM algorithm 은 <span style='color:#6666ff'>Expectation step</span> 과 <span style='color:#3399ff'>Maximization step</span> 으로 구분

- Expectation (기대값) step :
  - <span style='color:#3399ff'>현재의 추정된 parameter 를 통해 샘플을 cluster 에 assignment</span> 하는 단계
...
<span style='color:#6666ff'>현재의 추정된 parameter 를 통해 샘플을 cluster 에 assignment</span> 하는 단계
